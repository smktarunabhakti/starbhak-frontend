...
import FeatureCardNav, { FeatureCardNavProps } from "@/components/pages/home/features-card-nav";

export default function HomePage() {

  const [ data, setData ] = useState<FeatureCardNavProps[]>([])
      ...
      <div className="flex justify-between min-w-screen px-7 mt-8 gap-x-6">
        ...
        <div className="flex justify-center items-center mt-10 ">
          <div className="mt-2 flex justify-center items-center w-80 h-16 bg-[#1D70B4] rounded-3xl mb-2">
            <h1 className="text-white font-bold font-nunito text-3xl">Features</h1>
          </div>
        </div>
        {/* Pokja List Container */}
        <div className="justify-evenly gap-16 mb-5 inline-flex flex-wrap px-7 mt-8">
          {/* Pokja Card */}
            {
              data.map((e) => {
                return (
                  <FeatureCardNav title={e.title} img={LogoTB} href="/" description="Lorem ipsum dolor sit amet consectetur."/>
                )
              })
            }
          {/* End Pokja Card */}
        </div>
        {/* End Pokja List Container */}
        {/* End Pokja List */}
      </div>

      

<footer className="bg-[#204C6C] rounded-t-3xl dark:bg-[#204C6C]">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            <a href="https://smktarunabhakti.net" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                <Image src={LogoTB} alt="Flowbite Logo" width={80} height={69}/>
                <span className="self-center text-2xl font-semibold whitespace-nowrap text-white font-nunito">SMK Taruna Bhakti Depok</span>
            </a>
