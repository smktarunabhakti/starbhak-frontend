...
export default function MyForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      const response = await axios.put(`http://127.0.0.1:3000/api/v1/attendance/attendance-permittance${subjects_id}`, {
  ...
  async function fetchData() {
    try {
      const res = await axios.get(`http://127.0.0.1:3000/api/v1/attendance/attendance-permittance/${subjects_id}`);
